...
git clone https://github.com/stormbreaker-project/kernel_xiaomi_ysl --depth=1 --single-branch -b test kernel/xiaomi/ysl && git clone https://github.com/ItsVixano/android_device_xiaomi_ysl --depth=1 --single-branch -b r11.0 device/xiaomi/ysl && git clone https://github.com/ItsVixano/android_vendor_xiaomi_ysl --depth=1 --single-branch vendor/xiaomi/ysl
